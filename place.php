...
-->
    ...
    <div class="place__body">
        <div class="place__body__left">
            ...
            $reqs = "SELECT * FROM places WHERE id = '{$_GET['place']}'";
            $rply = $connection->query($reqs);
            while ($row = $rply->fetch_assoc()) {
            ?>
                <div class="body__left__route">
                    ...
                    <button id="btn-ruta">
                        <div class="route">
                            ...
                            <input id="direccion" type="text" hidden value="<?= $row['direction'] ?>">
                        </div>
                    </button>
                </div>
            <?php
