...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-07-2023 a las 18:30:19
...
(1, 1, 'Sitios arqueológicos'),
(2, 1, 'Playitas'),
(3, 1, 'Malls'),
(4, 19, 'Playitas lindas'),
(5, 19, 'Playas vergonas'),
(6, 19, 'solo playas'),
(7, 19, 'sip'),
(8, 19, 'nop'),
(9, 1, 'siwi');
...
(1, 1, 0, 'Muy bonito lugar'),
(2, 1, 3, 'Ahí se ahogó mi primo'),
(3, 1, 6, 'Extraño ir ahí de excursión'),
(4, 19, 3, 'Ahí se ahogó mi abuelo tambien'),
(5, 1, 4, 'Buena playa para hacer surf'),
(6, 1, 6, 'Bonito lugar'),
(7, 1, 1, 'Bonitooo');
...
INSERT INTO `places` (`id`, `name`, `description`, `direction`, `location`, `img1`, `img2`, `img3`, `department`, `type`, `public`, `rating`) VALUES
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `img`, `token`, `username`, `age`, `sex`, `number`, `address`, `language`, `code`, `verified`) VALUES
(1, 'Axel Ramirez', 'axelramireezz@gmail.com', '', 'https://lh3.googleusercontent.com/a/AAcHTtdwud2oM0DUII2C1rQ4AKXbGFTtOOml7orFN75cJ1c6=s96-c', '107045247008393752346', 'axeeell.r', 0, '', 0, '', '', 71308, 1),
...
(19, 'Zion', 'zion@gmail.com', '123456', '', '641149978582221463075', 'zionbabyyy', 17, 'Masculino', 0, 'Soyapango', 'Español', 0, 0),
(20, 'Paleta', 'renderosd1@gmail.com', 'puradoblep', '', '010622764163592891740', '', 0, '', 0, '', '', 44244, 0),
(21, 'axel2', 'axelby36@gmail.com', '123456', '', '982491014817580337460', '', 0, '', 0, '', '', 67195, 1),
(22, 'chepe pablo', 'chepepablo@gmail.com', '123456', '', '079580131204947342256', '', 0, '', 0, '', '', 85776, 0);
